  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        ...
        <div className="fixed top-0 left-0 right-0 h-16 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b z-40 flex items-center px-4">
      ...
      {/* Desktop Sidebar */}
      <div className="hidden lg:flex h-full w-64 flex-col bg-muted/40 border-r">
        <SidebarContent
          pathname={pathname}
          conversations={conversations}
          isLoading={isLoading}
